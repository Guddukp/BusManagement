...
{
	$sql5="SELECT `busagency`, `bus_name`, `bus_number`, `bus_type`, `buscapacity`, `total_seats`, `available_seats`, `route`, `start_point`, `departure`, `drop_point`, `arrival` FROM `bus_management` WHERE id='$id'";
	$run5=mysqli_query($this->dbh,$sql5);
	return $run5;
}
