...
<table class="table table-borderless table-striped table-vcenter">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlentities($run['available_seats']); ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlentities($run['departure']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><span class="text-right"> <?php echo htmlentities($run['arrival']); ?></span></td>
                    </tr>

                    <tr>
                      <td class="text-right"><strong>Bus Capacity:</strong></td>
                      <td><?php echo htmlentities($run['buscapacity']); ?></td>
                    </tr>
